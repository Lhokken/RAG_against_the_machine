funzione "walk" di "os" per cercare i file nella cartella vllm

cercare solo .txt .md e .py

langchain_text_splitters per chunkare i file
tre metodi pre splittare

bm25s per tokenizzare i chunk e dargli uno score
